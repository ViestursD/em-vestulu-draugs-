...
function append_full_citation(string $assistantText, array $selectedFiles): string {
  ...
  if (preg_match('/nav noteikta/ui', $nb['ats'])) {

    return $assistantText . "\n\n[CITĀTS]\nAtsauce nav noteikta, tāpēc citāts netiek pievienots.\n[/CITĀTS]";
  ...
  if (empty($citations)) {
    ...
    // Pievieno noklusējuma ziņojumu, ja citāti netiek atrasti

    return $assistantText . "\n\n[CITĀTS]\nCitāti netika atrasti izvēlētajos failos.\n[/CITĀTS]";

  }



  // Pievieno visus atrastos citātus
